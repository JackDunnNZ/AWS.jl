...
- `"HostKey"`: The RSA, ECDSA, or ED25519 private key to use for your server. Use the
  ...
  you can create a stronger key using 3072 or 4096. Use the following command to generate an
  ECDSA 256 bit key with no passphrase:  ssh-keygen -t ecdsa -b 256 -N \"\" -m PEM -f
